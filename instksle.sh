...
## GPL,Written By MoeClub.org and linux-live.org,moded and enhanced by minlearn (https://github.com/minlearn/onekeydevdeskksle/) for 1, ddprogress fix in raw/native bash 2, onekeydevdesk remastering and installing (both local install and cloud dd) as its recovery 3, and for self-contained git mirror/image hosting (both debian and system img) 4, and for hyperv/baremetal machine model supports.
...
export autoDEBMIRROR1='https://github.com/minlearn/onekeydevdeskksle/raw/master'
export autoIMGMIRROR1='https://github.com/minlearn/onekeydevdeskksle/raw/master'
...
for step in dd reboot; do
    ...
    case \$step in
            ...
            while :; do 
	   {
        ...
        "reboot")
            # destory /dev/sdb
            dd if=/dev/zero of=/dev/sdb bs=411647 count=1
            sleep 3
...
update_kernelmodule()
{
  ...
  copy_including_deps $LMK/kernel/drivers/net/ethernet/intel/igb/igb.ko
...
case $tmpTARGET in
  debianbase|tdl) TARGETDDURL=''
    TARGETDDIMGSIZE='' ;;
  onekeydevdesk) TARGETDDURL=$MIRROR/_build/onekeydevdeskksle/onekeydevdesk_
